...
//alert(valore)
		...
		{  
			...
			if(index==1){location.href=knomos_urlbase+"modules/prestazioni/pages/new_prestazione.php?ref_id="+valore;}//nuova prestazione
...
url=knomos_urlbase+"modules/prestazioni/pages/new_prestazione.php?ref_id="+id_pratica+"&mod=deriv"+"&gg="+ddd+"&mm="+mmd+"&aa="+yyd
//alert(url)
location.href=url
}

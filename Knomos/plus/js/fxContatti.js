...
{
//alert(knomos_urlbase)
variabile= knomos_urlbase + "modules/contact/pages/new_contact.php?ivires=" + iviresid + "&nome=" + nome +"&cod_fis=" + codfisc +"&luogo=" + luogo +"&giorno=" + g  +"&mese=" + m  +"&anno=" + a + "&PagProv=ContattoDaCF";
//alert(variabile)
//alert(window.name)

...
//Imposta la pagina a seconda della modalità
	...
	else //altrimenti
	{
		...
		// IN NOTA
		txNota="Deriva da: "+stringa+" del "+ddd+"-"+mmd+"-"+yyd
		document.MyForm.txInNota.value=txNota;
...
function CalcolaInsSel(var1,time1,liberi1,fatto1,evento1,tipo1,priorita1,codicek1)
{
...
document.MyForm.txGenere.value=tipo1;
document.MyForm.txEvento.value=evento1;
document.MyForm.txFatto.value=fatto1;
document.MyForm.txPriorita.value=priorita1;
...
document.MyForm.txGenere.value="-";
document.MyForm.txEvento.value="-";
document.MyForm.txFatto.value="-";
document.MyForm.txPriorita.value="-";
...
function AddeImpegno()
{
  ...
  else
  {
      ...
      {
	  //Se il termine prorogato viene utilizzato
      ...
      if (SeCalcolatoMano == "")
      {
		...
		var vTesto = splittata2[0];
	      //Genere
	      	...
	      	var vTipoScad=document.MyForm.txGenere.value;
	      	var vEvento=document.MyForm.txEvento.value;
	      	var vFatto=document.MyForm.txFatto.value;
	      	var vPriorita=document.MyForm.txPriorita.value;
		if (vTipoScad=="APPE" || vTipoScad=="APPI" || vTipoScad=="UD"){vOra="09:00";} else {vOra="00:00";} 
	      }
      
      else // inserimento a mano
      {
	var cod1 = ""; 
	var vTesto = ""; 
	Sel=document.getElementById("SelTipoImp"); 
	var vTipoScad = Sel.options[Sel.selectedIndex].value;
      	//Priorità
...
//alert(vModalita)
      ...
      {
      case "CalTerProc":
      TxUrl = knomos_urlbase + "modules/calendar/pages/new_app.php?gg=" + gg1 + "&mm=" + mm1 + "&aa=" + aa1 + "&orario=" + vOra +
      "&evento=" + vEvento + "&fatto=" + vFatto + "&codice=" + cod1 + "&descrizione=" + vTesto + "&priorita=" + vPriorita + "&genere=" +
      vTipoScad + "&PagProv=" + "CalcTerProc"+"&InNota="
      //"&PagProv=" + "CalcTerProc" 
      //alert(TxUrl)
	...
	//LinkImpegni = El.innerHTML;
      ...
      //alert(vId)
      var vTxInNota=document.MyForm.txInNota.value
      //COMPONE LA URL
      TxUrl = knomos_urlbase +  "modules/calendar/pages/new_app.php?ref_id=" + vId + "&gg=" + gg1 + "&mm=" + mm1 + "&aa=" + aa1 + "&orario=" + vOra +
      "&evento=" + vEvento +"&fatto=" + vFatto + "&codice=" + cod1 + "&descrizione=" + vTesto + "&priorita=" + vPriorita + "&genere=" + vTipoScad + 
      "&PagProv=" + "CalcImpCalcDeriv"+"&InNota="+vTxInNota
      // E LA LANCIA
      parent.location.href=TxUrl
      ...
      TxUrl = knomos_urlbase + "modules/calendar/pages/new_app.php?ref_id=" + vId + "&gg=" + gg1 + "&mm=" + mm1 + "&aa=" + aa1 + "&orario=" + vOra +
      "&evento=" + vEvento +"&fatto=" + vFatto + "&codice=" + cod1 + "&descrizione=" + vTesto + "&priorita=" + vPriorita + "&genere=" +
      vTipoScad + "&PagProv=" + "CalcImpCalcDeriv"+"&InNota="
      parent.location.href=TxUrl
      //alert(TxUrl)
...
document.MyForm.ckLib1.checked==false;
document.MyForm.MyCalcolaIn1.value="g";
document.MyForm.SelTipoImpegno.value="SCAD";
...
var vGMA = splittata[1]
var vLib = splittata[2]
var vFatto =splittata[3]
var vEvento =splittata[4]
var vTipo =splittata[5]
var vPriorita = splittata[6]
var vCodK =splittata[7]


//Prende il termine dal testo della select
//var i;
...
CalcolaInsSel(vTermine,vGMA,vLib,vFatto,vEvento,vTipo,vPriorita,vCodK)

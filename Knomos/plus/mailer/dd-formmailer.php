...
$language = 'lang/Italian.php';

// FULL URL TO SCRIPT
// The full URL to dd-formmailer.php (or whatever you have renamed it to)

$script_path = 'http://supportoknomos.altervista.org/dd-formmailer.php';
...
$form_struct = '
	...
	type=text|class=fmtext|label=Oggetto|fieldname=fm_subject|max=100|req=true
	type=verify|class=fmverify|label=Codice
	type=textarea|class=fmtextarea|label=Messaggio|fieldname=fm_message|max=1000|rows=6|req=true
';
...
$sent_message = '<p><b>Grazie! Messaggio inviato</b></p>';

...
$thisform= load_fwobject("form",$module,20);
...
if (isset($_GET[id]) && $_POST[form_id]!= $thisform["name"])
{
	...
	$rs=$DB->Execute("SELECT * FROM INT_uff_giud WHERE id=".$_GET[id]);
	$result=$rs->FetchRow();
	...
	$response[text]= ADMIN_UG_UPD_DONE_TXT."<br><br>".make_button("tip_uff_giud_view.php",ADMIN_UG_BACK_LIST);
...
{ 
	...
	$response[text]= ADMIN_UG_ADD_DONE_TXT."<br><br>".make_button("tip_uff_giud_view.php",ADMIN_UG_BACK_LIST);

...
<table width="100%" border="0" cellspacing="1" name="TableImpPen">
	<tr name="DivTitolo" id="IT">
		<td width="100%" colspan="2"
			onMouseOver="this.className='pratica-over-sub'"
			onMouseOut="this.className='null'"><span class="pratica-resalt-01">
		&nbsp;&nbsp;<span> Selezionare un collegamento <?
		...
		//Riempie il select
		?> <select name='Selink' id='selink' size='1'
			onchange='javascript:ApriLinkDaSelect()' class=''
			onFocus=(this.className= 'campo-focus-02') onBlur=(this.className='null')>

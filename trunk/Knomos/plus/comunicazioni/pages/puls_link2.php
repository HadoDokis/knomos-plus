...
<link href="/template/skin_sutti/css/stili_sutti_main.css" rel="stylesheet" type="text/css">
  ...
  <body>
	<div style="width:99%;"  class="pratica" id = "TableImpegniVeloci" border="0" cellpadding="0" cellspacing="0">
<p align="center">
...
<?
	...
	{ 
		...
		$url=$campo['url'];
		?> 
		<input  class='bot-submit' value="<? echo $desc ?>" name='test1' onclick=parent.Frame1.location.href='<? echo $url ?>' type='button'> 
		<?
		$x=$x+1;
		}
	}

...
$PAGE[TXT_TITLE]=$CONF[label_link1];
$PAGE[PAGE_PICTITLE]=$CONF[ico_link1];
$PAGE[PAGE_INTITLE]=$CONF[label_link1].
'
<iframe  VSPACE="0" name="FrameSel" id="FrSel"  src="sel_link1.php"  width="99%" height="25px" frameborder=0 MARGINWIDTH="0" marginheight="0"> </iframe>
';
...
<iframe  VSPACE="0" name="FramePuls" id="FrPuls"  src="puls_link1.php"  width="100%" height="75px" frameborder=0 MARGINWIDTH="0" marginheight="0"> </iframe>

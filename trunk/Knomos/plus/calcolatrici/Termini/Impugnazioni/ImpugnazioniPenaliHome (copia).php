...
<div class="pratica" name="DivImpPen">
...
<br>
	...
	<select name="SelTipoScadenza" size="1" id="SelScad" class=""  onFocus="this.className='campo-focus-02'" onBlur="this.className='null'">
	<option value="1">Scadenza impugnazione</option>
	<option value="2">Scadenza impugnazione (senza spostamento per il feriato)</option>
	<option value="3">Scadenza impugnazione (senza spostamento per festiv. naz.)</option>
	<option value="4">Termine per il deposito della motivazione</option>
	<option value="5">Notifica estratto contumaciale</option>
	<option value="6">Notifica avviso di deposito tardivo</option>
	</select>

	<table style="display: none" width="100%"  id= "TabRiep" border="0" cellspacing="1">
	<tr>
	<td width="100%" onMouseOver="this.className='pratica-over-sub'" onMouseOut="this.className='null'" >

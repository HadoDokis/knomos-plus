...
<script language="JavaScript" src="Fx_IntLegali.js" type="text/javascript"></script>
...
<th colspan="2" width="100%" align="left"><span class="pratica-tit">
 Calcolatore di interessi legali</span></th>
</tr>
...
<input size="39" maxlength="15"  value="" name="TxCapitale" class=""  onFocus="this.className='campo-focus-02'" onBlur="this.className='null'">
	...
	<td width="50%" onMouseOver="this.className='pratica-over-sub'" onMouseOut="this.className='null'" >
     <form style="font-family: Helvetica,Arial,sans-serif;" method="post" name="DataDa" >
	...
	<tr>
	<td width="50%" onMouseOver="this.className='pratica-over-sub'" onMouseOut="this.className='null'" >
      <form style="font-family: Helvetica,Arial,sans-serif;" method="post" name="DataA" >
...
<td width="100%" colspan="2" onMouseOver="this.className='pratica-over-sub'" onMouseOut="this.className='null'">
      ...
      <input class="bot-submit" id="PulsCal" value="Calcola" name="CalcolaButton" onclick="CalcolaIntLeg();" type="button">
...
<td width="100%"  colspan="2" onMouseOver="this.className='pratica-over-sub'" onMouseOut="this.className='null'">
   ...
   <div style="width:511px; height: 159px; display:none; " value="gigi" id="Tab2" name="TabRiepilogo"  >
	    <span class="pratica-resalt-01">
	    Riepilogo dei calcoli:
	    </span>
	    <br>
	    <form style="font-family: Helvetica,Arial,sans-serif; " method="post" name="Caselle" >
	    <p>Dalla data iniziale al 15-12-1990:<br> saggio: 
	    <input style="text-align: right" name="txSaggio022" size="5" value="5.00" readonly="readonly" type="text" > 
	    ...
	    <p>Dal 16-12-1990 al 31-12-1996:<br> saggio:<input style="text-align: right" name="txSaggio031" size="5" value="10.00" readonly="readonly" type="text" > 
	    ...
	    <p>Dal 1-1-1997 al 31-12-1998:<br> saggio: <input style="text-align: right" name="txSaggio032" size="5" value="5.00" readonly="readonly" type="text" > 
	    ...
	    <p>Dal  1-1-1999  al 31-12-2000:<br> saggio: <input style="text-align: right" name="txSaggio041" size="5" value="2.5" readonly="readonly" type="text" > 
	    ...
	    <p>Dal  1-1-2001  al 31-12-2001:<br> saggio: <input style="text-align: right" name="txSaggio042" size="5" value="3.5" readonly="readonly" type="text" > 
	    ...
	    <p>Dal  1-1-2002  al 31-12-2003:<br> saggio: <input style="text-align: right" name="txSaggio051" size="5" value="3" readonly="readonly" type="text" > 
	    ...
	    <p>Dal  1-1-2004  al 31-12-2007:<br> saggio: <input style="text-align: right" name="txSaggio052" size="5" value="2.5" readonly="readonly" type="text" > 
	    ...
	    <p>Dal  1-1-2008  al 31-12-2009:<br> saggio: <input style="text-align: right" name="txSaggio061" size="5" value="3" readonly="readonly" type="text" > 
	    ...
	    <p>Dal  1-1-2010 alla data finale: (max. 31-12-2010)
	    <br> saggio: <input style="text-align: right" name="txSaggio062" size="5" value="1" readonly="readonly" type="text" > 

...
$thisform= load_fwobject("form",$module,1);
...
if (isset($_GET[id]) && $_POST[form_id]!= $thisform["name"])
{
	...
	$rs=$DB->Execute("SELECT * FROM INT_calendar_tipo WHERE id=".$_GET[id]);
	$result=$rs->FetchRow();
	...
	$response[text]= ADMIN_CT_UPD_DONE_TXT."<br><br>".make_button("users_view.php",ADMIN_CT_BACK_LIST);
...
{ 
	...
	$response[text]= ADMIN_CT_ADD_DONE_TXT."<br><br>".make_button("users_view.php",ADMIN_CT_BACK_LIST);

...
$thisform= load_fwobject("form",$module,93);
...
if (isset($_GET[id]) && $_POST[form_id]!= $thisform["name"])
{
	...
	$PAGE[PAGE_INTITLE]=ADMIN_SET_UPD." DROPBOX";
	$PAGE[TXT_TITLE]=ADMIN_SET_UPD." DROPBOX";
...
{ 
	...
	$response[text]= ADMIN_SET_ADD_DONE_TXT."<br><br>".make_button("set_home_view.php",ADMIN_SET_BACK_LIST);

...
} elseif (isset($_GET[id]))
{
	...
	{
//modifica per carratelli!!! commentate le seguenti 4 righe ed aggiunta la quinta...
//		if ($_POST[form_id]== $thisform["name"]) $result=$_POST;
//		else {
//			$result[permessi]="U".$_SESSION[fw_userid]."=66666";
//		}
		$result[permessi]="U3=6666|U4=6666|U5=6666|U6=6666|U7=6666|U8=6666|U9=6666|U10=6666|U11=6666|U12=6666|U13=6666";

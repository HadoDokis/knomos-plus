...
$treemid->setMenuStructureFile('layersmenu-vertical-3.txt');
...
$phptreemid->setPHPTreeMenuDefaultExpansion('2|3');
$phptreemid->setMenuStructureFile('layersmenu-vertical-3.txt');
...
$plainmid->setMenuStructureFile('layersmenu-vertical-3.txt');
